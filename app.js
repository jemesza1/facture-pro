...
var V="20260819a";
var core=["lib-calc.js","a.js","dash-fix.js","b1.js","b2a.js","b2b.js","c1.js","c2.js","extra.js","pro-polish.js","commerce.js","lib-xlsx.js","excel.js","backup.js","avoir.js","bl.js","feedback.js"];
...
.then(function(){
  ...
  try{if(typeof initApp==="function")initApp();else{loadData();var _p=(typeof state!=="undefined"&&state.currentPage)||"dashboard";var _ok=["dashboard","invoices","devis","products","payments","debts","clients","templates","settings","help","terms"];navigate(_ok.indexOf(_p)>-1?_p:"dashboard");}}catch(e){console.error(e);}
